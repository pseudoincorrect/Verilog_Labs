...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=4 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
module  fconvert2_altbarrel_shift_tvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fconvert2_altbarrel_shift_tvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fconvert2_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fconvert2_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fconvert2_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //fconvert2_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fconvert2_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fconvert2_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //fconvert2_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fconvert2_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fconvert2_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	fconvert2_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //fconvert2_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fconvert2_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	fconvert2_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //fconvert2_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fconvert2_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fconvert2_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //fconvert2_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	fconvert2_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	fconvert2_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //fconvert2_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fconvert2_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fconvert2_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //fconvert2_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fconvert2_altfp_convert_96n
	( 
	clock,
	dataa,
	result) ;
	...
	fconvert2_altbarrel_shift_tvf   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fconvert2_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
	...
	assign
		...
		bias_value_w = 8'b01100011,
		clk_en = 1'b1,
		const_bias_value_add_width_int_w = 8'b10000001,
...
endmodule //fconvert2_altfp_convert_96n
//VALID FILE
...
module fconvert2 (
	...
	fconvert2_altfp_convert_96n	fconvert2_altfp_convert_96n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
